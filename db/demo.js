module.exports = function(client) {
  ...
  client.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('kyamamoto@dreamhouseappjp.io', '03-2244-3672', '山本 香澄', '090-4244-3672', '', '住宅コンサルタント', 'https://static.dreamhouseappjp.io/images/dreamhousejp-broker1.jpg');`);
  client.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('jshindo@dreamhouseappjp.io', '03-2444-3674', '新堂 純一', '090-2344-3672', '', '主任住宅コンサルタント', 'https://static.dreamhouseappjp.io/images/dreamhousejp-broker2.jpg');`);
  client.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('syokoyama@dreamhouseappjp.io', '03-2434-4672', '横山 さおり', '090-9244-3672', '', '住宅コンサルタント', 'https://static.dreamhouseappjp.io/images/dreamhousejp-broker3.jpg');`);
  client.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('makiyama@dreamhouseappjp.io', '03-4244-3672', '秋山 美幸', '090-1244-3672', '', 'シニア住宅コンサルタント', 'https://static.dreamhouseappjp.io/images/dreamhousejp-broker4.jpg');`);
  client.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('msubo@dreamhouseappjp.io', '03-6244-3672', '周防 美雨', '090-5244-3672', '', 'アソシエイト住宅コンサルタント', 'https://static.dreamhouseappjp.io/images/dreamhousejp-broker5.jpg');`);
  client.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('yoshitaka@dreamhouseappjp.io', '03-4244-3672', '吉高 幸司', '090-0244-3672', '', '主任住宅コンサルタント', 'https://static.dreamhouseappjp.io/images/dreamhousejp-broker6.jpg');`);
  client.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('mtakahashi@dreamhouseappjp.io', '03-1244-3672', '高橋 美春', '090-2244-3672', '', '住宅コンサルタント', 'https://static.dreamhouseappjp.io/images/dreamhousejp-broker7.jpg');`);
  client.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('ykakefu@dreamhouseappjp.io', '03-2444-3672', '掛布 洋子', '090-1244-3672', '', '住宅コンサルタント', 'https://static.dreamhouseappjp.io/images/dreamhousejp-broker8.jpg');`);
